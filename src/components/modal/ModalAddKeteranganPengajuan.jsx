...
const ModalAddKeteranganPengajuan = ({ idSubs, setBukaModal }) => {
  const [keterangan, setKeterangan] = useState("");
  const TodalSubs = async () => {
    try {
      await axios.patch(`http://localhost:5000/submissions/tolak/${idSubs}`, {
...
export default ModalAddKeteranganPengajuan;
